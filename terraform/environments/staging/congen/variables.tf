...
variable "vault_secret_path_prefix" {
  description = "Path prefix for secrets in Vault (from vault module)"
  type        = string
}

variable "vault_kubernetes_auth_backend_path" {
  description = "Kubernetes auth backend path in Vault (from vault module)"
  type        = string
}
...
variable "vault_kubernetes_role" {
  description = "Kubernetes auth role name (from vault module)"
  type        = string
}
...
variable "eks_cluster_id" {
  description = "EKS cluster ID (from aws-infrastructure module)"
  type        = string
}
