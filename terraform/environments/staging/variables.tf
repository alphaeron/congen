variable "keycloak_url" {
  ...
  type        = string
  default     = "https://keycloak.staging.congen.com"
}
...
variable "realm_display_name" {
  ...
  type        = string
  default     = "Congen Staging"
}

variable "realm_display_name_html" {
  description = "Keycloak realm display name HTML"
  type        = string
  default     = "<div class=\"kc-logo-text\"><span>Congen Staging</span></div>"
}
...
variable "frontend_redirect_uris" {
  ...
  default = [
    ...
    "https://staging.congen.com/profile/create",
