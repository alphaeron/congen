...
export const AdventurerStatusCard: React.FC<AdventurerStatusCardProps> = ({
  ...
  return (
    ...
    >
      <GameCard className={GAME_CLASSES.overflowVisible} interactive={true}>
        <CardHeader
          title={
            <Box className={GAME_CLASSES.textCenter}>
              <GameText variant="h3" textVariant="glow" className={GAME_CLASSES.textBold}>
                STATUS
              </GameText>
            </Box>
          }
                ...
                <Stack direction="column" alignItems="center">
                  <Stack direction="row" alignItems="flex-start" spacing={2}>
                    <motion.div
                      ...
                      animate={
                        isProfileInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.95 }
                      }
                    ...
                    >
                      <Stack
                        direction="column"
                        alignItems="center"
                        className={GAME_CLASSES.rowGap0}
                      >
                        <CustomSvgIcon
                          src={ProfileIcon}
                          alt="Profile"
                    ...
                    <motion.div
                      ...
                      initial={{ opacity: 0, scale: 0.95 }}
                      animate={
                        isLevelInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.95 }
                      }
