          ...
          >
            ...
            >
              ...
              <motion.div variants={textRevealVariants}>
                <GameText
                  ...
                  sx={{
                    ...
                    textShadow:
                      '0 0 40px rgba(14, 165, 233, 0.4), 0 0 80px rgba(249, 115, 22, 0.2)',
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  An advanced algorithmic conjugate method workout generator. Experience
                  personalized powerlifting programming with RPG-style gamification, automatic
                  exercise rotation, and comprehensive performance tracking.
                </GameText>
              </motion.div>
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  {['Level Progression', 'Performance Tracking', 'Skill System'].map(
                    (feature, index) => (
                      <Box
                        key={index}
                        sx={{
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Box
                      ...
                      sx={{
                        ...
                        boxShadow:
                          '0 8px 25px rgba(14, 165, 233, 0.4), 0 0 0 1px rgba(255,255,255,0.1)',
                        textDecoration: 'none',
                        ...
                        '&:hover': {
                          boxShadow:
                            '0 12px 35px rgba(14, 165, 233, 0.6), 0 0 0 1px rgba(255,255,255,0.2)',
                          textDecoration: 'none',
                          color: 'white',
                          '&::before': {
                            left: '100%',
                    ...
                    <Box
                      ...
                      sx={{
                        ...
                        '&::before': {
                          ...
                          bottom: 0,
                          background:
                            'linear-gradient(135deg, rgba(14, 165, 233, 0.1), rgba(249, 115, 22, 0.05))',
                          opacity: 0,
