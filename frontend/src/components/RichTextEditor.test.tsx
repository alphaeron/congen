...
jest.mock('slate-react', () => ({
  Slate: ({
    ...
    initialValue: MockSlateValue[];
    onChange: (value: MockSlateValue[]) => void;
  }) => (
...
describe('RichTextEditor', () => {
  ...
  it('applies custom styling props', () => {
    const { container } = render(
      <RichTextEditor value="" onChange={mockOnChange} minHeight={200} maxHeight={400} />
    );
  ...
  it('hides help text when in read-only mode', () => {
    ...
    expect(
      screen.queryByText(/Use Ctrl\+B, Ctrl\+I, Ctrl\+U for formatting/)
