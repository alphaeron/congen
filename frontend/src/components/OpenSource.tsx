      ...
      <Box
        ...
        sx={{
          ...
          '&::before': {
            ...
            right: 0,
            bottom: 0,
            background: `radial-gradient(circle at 20% 20%, ${alpha('#0ea5e9', 0.025)} 0%, transparent 50%),
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              No subscriptions, no hidden costs, no vendor lock-in. Use it, modify it, and
              contribute to the future of fitness technology. Your data stays yours, and the code is
              yours to explore.
            </GameText>
