...
describe("ExerciseDetails component", () => {
  ...
  beforeEach(() => {
    ...
    mockAdapter
      .onGet(`/exercise/${EXERCISE.name}/equipment`)
      .reply(200, [EXERCISE_EQUIPMENT]);
    mockAdapter
      .onGet(`/exercise/${EXERCISE.name}/muscle`)
      .reply(200, [EXERCISE_MUSCLE]);
    mockAdapter
      .onGet(`/equipment/${EXERCISE_EQUIPMENT.equipmentName}`)
      .reply(200, EQUIPMENT);
    mockAdapter
      .onGet(`/muscle/${EXERCISE_MUSCLE.muscleName}`)
      .reply(200, MUSCLE);
