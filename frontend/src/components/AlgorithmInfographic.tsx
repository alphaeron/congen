...
const STAGES = {
  ...
  available_equipment: {
    ...
    title: 'Available Equipment Filter',
    componentType: 'filter',
    shape: 'rounded-rect',
    ledColor: '#ff8ab6',
  },
  exercise_matching: {
    id: 'exercise_matching',
    title: 'Exercise Matching Logic',
    componentType: 'processor',
    shape: 'rounded-rect',
    ledColor: '#f59e0b',
  },
  ...
  rotating_exercise_selection: {
    id: 'rotating_exercise_selection',
    title: 'Rotating Exercise Selection',
    componentType: 'processor',
    shape: 'rounded-rect',
    ledColor: '#7ef27e',
  },
  weak_point_targeting: {
    id: 'weak_point_targeting',
  ...
  movement_balancing: {
    id: 'movement_balancing',
    title: 'Movement Balancing',
    componentType: 'processor',
    shape: 'rounded-rect',
    ledColor: '#7dd3fc',
  },
  ...
  set_scheme_generation: {
    id: 'set_scheme_generation',
    title: 'Set Scheme Generation',
    componentType: 'processor',
    shape: 'rounded-rect',
    ledColor: '#f59e0b',
  },
      ...
      {!(node.shape === 'triangle' && groupIndex === 3) && (
        <motion.div
          ...
          animate={{
            ...
            borderColor: [COLORS.electricity, COLORS.electricityBright, COLORS.electricity],
          }}
          transition={{
            delay: totalDelay,
            duration: 1.5,
        ...
        <React.Fragment>
          ...
          >
            <motion.polygon
              ...
              strokeWidth="2"
              animate={{
                stroke: [COLORS.electricity, COLORS.electricityBright, COLORS.electricity],
                strokeWidth: [2, 3, 2],
              }}
              transition={{
                delay: totalDelay,
          ...
          >
            {wrappedText.map((line, index) => (
              <div
                key={index}
                style={{ marginBottom: index < wrappedText.length - 1 ? '1px' : '0' }}
              >
                {line}
              </div>
            ))}
    ...
    <Box
      ...
      sx={{
        ...
        '&::before': {
          ...
          right: 0,
          bottom: 0,
          background: `radial-gradient(circle at 20% 20%, ${alpha('#00bcd4', 0.02)} 0%, transparent 50%),
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Our sophisticated conjugate method algorithm automatically selects exercises, calculates
            optimal weights, and structures your workouts based on proven scientific principles.
          </GameText>
          <Box
            sx={{
              display: 'flex',
          ...
          >
            {['Conjugate Method', 'Exercise Rotation', 'Load Balancing', 'Weak Point Training'].map(
              (feature, index) => (
                <GameCard
                  key={index}
                  sx={{
                ...
                >
                  <GameText variant="body1" textVariant="glow" sx={{ fontWeight: 600 }}>
                    {feature}
                  </GameText>
                </GameCard>
              )
          ...
          >
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  animate={{
                    ...
                    background: [COLORS.electricity, COLORS.electricityBright, COLORS.electricity],
                  }}
                  transition={{
                    delay: 0,
                    duration: 2,
              ...
              >
                ...
                <div style={{ position: 'relative' }}>
                  <CircuitComponent
                    node={STAGES.available_equipment}
                    groupIndex={1}
                    itemIndex={1}
                  />
                  {/* Enhanced line extending from right edge */}
              ...
              >
                ...
                >
                  ...
                  <div style={{ position: 'relative' }}>
                    <CircuitComponent
                      node={STAGES.session_time_allocation}
                      groupIndex={2}
                      itemIndex={0}
                    />
                  ...
                  <div style={{ position: 'relative' }}>
                    <CircuitComponent
                      node={STAGES.rotating_exercise_selection}
                      groupIndex={2}
                      itemIndex={1}
                    />
                    {/* Line extending from right edge */}
                  ...
                  <div style={{ position: 'relative' }}>
                    <CircuitComponent
                      node={STAGES.weak_point_targeting}
                      groupIndex={2}
                      itemIndex={2}
                    />
                    {/* Vertical line from top of component to group top */}
                ...
                >
                  ...
                  <div style={{ position: 'relative' }}>
                    <CircuitComponent
                      node={STAGES.movement_balancing}
                      groupIndex={2}
                      itemIndex={3}
                    />
                    {/* Line extending from right edge */}
                  ...
                  <div style={{ position: 'relative' }}>
                    <CircuitComponent
                      node={STAGES.set_scheme_generation}
                      groupIndex={2}
                      itemIndex={5}
                    />
                    {/* Vertical line from bottom of component to group bottom */}
