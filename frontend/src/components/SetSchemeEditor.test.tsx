...
describe('SetSchemeEditor', () => {
  ...
  it('disables edit button when isMostRecentWeek is false', () => {
    ...
    const editButton = screen.getByRole('button', { name: /editing only available for most recent week/i });
  ...
  it('submits form with valid data', async () => {
    const user = userEvent.setup();
    const { updateProgrammedExercise } = require('../api/programmedExercise');
    const { updateSetScheme } = require('../api/setScheme');
