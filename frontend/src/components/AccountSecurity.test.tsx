...
describe('AccountSecurity', () => {
  ...
  it('renders the component with correct title and description', () => {
    ...
    expect(screen.getByText(/Manage your account security settings and access controls/)).toBeInTheDocument();
  });
  ...
  it('displays security settings section', () => {
    ...
    expect(screen.getByText(/Configure your account security preferences and access controls/)).toBeInTheDocument();
  ...
  it('deletes account successfully', async () => {
    mock.onDelete('/gdpr/delete_all_personal_data/test-user-id').reply(200, { message: 'Account deleted successfully' });
  ...
  it('shows error when account deletion fails', async () => {
    mock.onDelete('/gdpr/delete_all_personal_data/test-user-id').reply(500, { message: 'Internal server error' });
