...
import {
  ...
  pulseVariants,
  bounceVariants,
  programBounceVariants,
  floatingVariants,
  questGlowVariants,
  programPulseVariants,
  shimmerVariants,
  programShimmerVariants,
...
const animationVariants = {
  ...
  programSlideIn: programSlideInVariants,
  ...
  programBounce: programBounceVariants,
  floating: floatingVariants,
  questGlow: questGlowVariants,
  programPulse: programPulseVariants,
  shimmer: shimmerVariants,
  programShimmer: programShimmerVariants,
