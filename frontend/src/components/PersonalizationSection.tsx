...
const personalizationNodes = [
  ...
  { id: 'tracking', label: 'Workout Tracking', details: ['Record Performance'] },
  {
    ...
    details: ['Calculate Scores', 'Leveling Progression'],
  },
];
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Every aspect of your program is algorithmically tailored to your equipment, goals,
                experience level, and physical attributes. Real-time adjustments ensure continuous
                  ...
                  >
                    <GameCard
                      sx={{
                        ...
                        boxShadow: () => `0 8px 32px ${alpha('#22c55e', 0.1)}`,
                        transition: 'all 0.3s ease',
                        '&:hover': {
                          boxShadow: () => `0 20px 40px ${alpha('#22c55e', 0.3)}`,
            ...
            >
              <CycleDiagram nodes={personalizationNodes} />
            </Box>
          </Box>
        </Box>
      </motion.div>
