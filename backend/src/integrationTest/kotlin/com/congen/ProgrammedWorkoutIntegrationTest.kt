...
class ProgrammedWorkoutIntegrationTest : BaseIntegrationTest() {
    ...
    fun `should get programmed workouts by program id`() {
        ...
        val programId2 = IntegrationTestHelpers.createTestProgram(webTestClient, userId2, name = "Test Program 2", token = serviceToken)
    ...
    fun `should get all programmed workouts`() {
        ...
        val programId = IntegrationTestHelpers.createTestProgram(webTestClient, userId, token = serviceToken)
        val workout1 =
            IntegrationTestHelpers.createTestProgrammedWorkout(
                webTestClient,
                programId,
    ...
    fun `should update programmed workout`() {
        ...
        val programId3 = IntegrationTestHelpers.createTestProgram(webTestClient, userId3, name = "Test Program 3", token = serviceToken)
