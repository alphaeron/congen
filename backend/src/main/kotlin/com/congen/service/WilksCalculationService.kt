...
class WilksCalculationService(
    ...
    companion object {
         ...
         */
        private val MALE_WILKS_COEFFICIENTS = doubleArrayOf(
            -216.0475144,      // a0
            16.2606339,        // a1
            -0.002388645,      // a2
            -0.00113732,       // a3
         ...
         * Source: https://en.wikipedia.org/wiki/Wilks_Coefficient
         */
        private val FEMALE_WILKS_COEFFICIENTS = doubleArrayOf(
            594.31747775582,   // a0
            -27.23842536447,   // a1
            0.82112226871,     // a2
            -0.00930733913,    // a3
     ...
     */
    fun calculateWilksScore(keycloakId: String, bodyWeightKg: Double, isMale: Boolean): Mono<Double?> {
        ...
        return userOneRepMaxDAL.selectUserOneRepMaxByUser(keycloakId)
            .map { oneRepMaxes ->
                try {
                    ...
                    logger.debug("Wilks calculation: Total=$total, BodyWeight=$bodyWeightKg, Coefficient=$wilksCoefficient, Score=$wilksScore")
     ...
     */
    private fun findOneRepMax(oneRepMaxes: List<com.congen.model.UserOneRepMax>, exerciseNames: List<String>): BigDecimal? {
     ...
     */
    private fun getMissingLifts(squat: BigDecimal?, bench: BigDecimal?, deadlift: BigDecimal?): String {
     ...
     */
    private fun calculateWilksCoefficient(bodyWeightKg: Double, isMale: Boolean): Double {
