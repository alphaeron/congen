 ...
 * @property currentWeekNumber The current week number of the program
 * @property createdAt The timestamp when the program was created
 * @property updatedAt The timestamp when the program was last updated
 * @property isActive Whether this program is currently active for the user
 *
