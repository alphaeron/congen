...
class VertxConfig : DisposableBean {
    ...
    fun vertx(): Vertx {
        logger.info(
            "Creating Vert.x instance with worker pool size: {}, internal blocking pool size: {}",
            WORKER_POOL_SIZE,
        ...
        logger.info(
            "Vert.x instance created successfully with worker pool size: {}, internal blocking pool size: {}",
            WORKER_POOL_SIZE,
            INTERNAL_BLOCKING_POOL_SIZE
        )
