...
INSERT INTO exercise_workout_type (exercise_name, movement_type, workout_type) VALUES
  ('Close Grip Lat Pulldown', 'vertical_pull', 'dynamic_effort'),
  ('Close Grip Lat Pulldown', 'vertical_pull', 'maximal_effort');
