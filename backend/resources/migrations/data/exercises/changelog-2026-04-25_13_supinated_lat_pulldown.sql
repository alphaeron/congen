...
INSERT INTO exercise_workout_type (exercise_name, movement_type, workout_type) VALUES
  ('Supinated Lat Pulldown', 'vertical_pull', 'dynamic_effort'),
  ('Supinated Lat Pulldown', 'vertical_pull', 'maximal_effort');
