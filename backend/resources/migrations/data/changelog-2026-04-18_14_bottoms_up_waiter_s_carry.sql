...
INSERT INTO exercise_muscle (exercise_name, muscle_name) VALUES
  ('Bottoms Up Waiter\'\'s Carry', 'obliques'),
  ('Bottoms Up Waiter\'\'s Carry', 'rotator cuff');
INSERT INTO exercise_equipment (exercise_name, equipment_name) VALUES
  ('Bottoms Up Waiter\'\'s Carry', 'kettlebell');
INSERT INTO exercise_workout_type (exercise_name, movement_type, workout_type) VALUES
  ('Bottoms Up Waiter\'\'s Carry', 'isolation', 'dynamic_effort'),
  ('Bottoms Up Waiter\'\'s Carry', 'isolation', 'maximal_effort');
