...
('vertical_jump', 'Vertical Jump', 'Measure vertical jump height', 'cm', 'fitness_center', true, 1, '#FF6B6B', true),
('hr_recovery', 'HR Recovery', '1-minute heart rate drop after exercise', 'bpm drop', 'favorite', true, 2, '#4ECDC4', true),
('reflex', 'Reflex Speed', 'Reaction time test', 'ms', 'psychology', true, 3, '#DDA0DD', true),
