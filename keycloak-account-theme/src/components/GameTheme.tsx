...
export const GameSubCard: React.FC<React.ComponentProps<typeof Card>> = ({
  className = '',
  ...props
}) => <Card className={`${GAME_CLASSES.subCard} ${className}`} {...props} />;

// Game Status Chip Component
export const GameStatusChip: React.FC<
  React.ComponentProps<typeof Chip> & {
    status?: 'PENDING' | 'COMPLETED' | 'SKIPPED' | 'ERROR' | 'WARNING' | 'INFO' | 'SUCCESS';
  }
> = ({ className = '', status = 'PENDING', ...props }) => {
  ...
  return (
    <Chip className={`${GAME_CLASSES.statusChip} ${getStatusClass()} ${className}`} {...props} />
  );
};
...
export const GameSkillChip: React.FC<React.ComponentProps<typeof Chip>> = ({
  className = '',
  ...props
}) => <Chip className={`${GAME_CLASSES.skillChip} ${className}`} {...props} />;
...
> = ({ className = '', textVariant = 'primary', ...props }) => {
  ...
  return <Typography className={`${getVariantClass()} ${className}`} {...props} />;
};

// Alias for secondary text
export const GameTextSecondary: React.FC<
  Omit<React.ComponentProps<typeof Typography>, 'textVariant'> & {
    textVariant?: never;
  }
> = ({ className = '', ...props }) => (
  <GameText textVariant="secondary" className={className} {...props} />
);
...
> = ({ className = '', _variant = 'primary', ...props }) => (
  <button className={`${GAME_CLASSES.button} ${className}`} {...props} />
);
