...
class ExerciseMuscleIntegrationTest : BaseIntegrationTest() {
    ...
    fun `should create exercise muscle relationship`() {
        ...
        webTestClient.post()
            .uri("/exercise/?name=$uniqueExercise&description=Test exercise for muscle relationship&movementType=horizontal_push&isUnilateral=false&isUpper=true&isAccessory=false")
            .exchange()
            .expectStatus().isOk()
