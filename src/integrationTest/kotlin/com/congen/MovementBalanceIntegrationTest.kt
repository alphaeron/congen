...
class MovementBalanceIntegrationTest : BaseIntegrationTest() {
    ...
    private fun setupUserProgramPreferences(userId: Int, daysPerWeek: Int, sessionLength: Int) {
        webTestClient.post()
            .uri(
    ...
    private fun setupUserOneRepMaxes(userId: Int, oneRepMaxes: List<Pair<String, BigDecimal>>) {
    ...
    private fun checkMovementBalance(programId: Int, workoutIndex: Int) {
                ...
                .jsonPath("$.id").value<Int> { programId ->
                    ...
                    val workoutResponse = webTestClient.post()
                        ...
                        .jsonPath("$.id").value<Int> { _ ->
                            ...
                            val workouts = webTestClient.get()
                                .uri("/api/v1/programmed_workout/program/$programId")
                                .exchange()
                                .expectStatus().isOk
                                .expectBody()
                                ...
                                .jsonPath("$.length()").value<Int> { workoutCount ->
                                    assert(workoutCount == expectedWorkoutCounts[userIndex]) { 
                                        "Expected ${expectedWorkoutCounts[userIndex]} workouts for user ${userIndex + 1}, got $workoutCount" 
                                    }
    ...
    fun `should generate workout with balanced movement types for different session lengths`() {
        ...
        val programResponse2 = webTestClient.post()
            ...
            .jsonPath("$.id").value<Int> { programId2 ->
                // Generate next week of workouts
                val workoutResponse2 = webTestClient.post()
    ...
    fun `should generate workout with balanced movement types for different one rep max profiles`() {
        ...
        val balancedOneRepMaxes = listOf(
            "Bench Press" to BigDecimal("120"),
            "Overhead Press" to BigDecimal("100"),
            "Bent-Over Row" to BigDecimal("90"),
            "Chin-Up" to BigDecimal("80"),
        ...
        val pushDominantOneRepMaxes = listOf(
            "Bench Press" to BigDecimal("150"), // Stronger push
            "Overhead Press" to BigDecimal("120"), // Stronger push
            "Bent-Over Row" to BigDecimal("80"), // Weaker pull
            "Chin-Up" to BigDecimal("60"), // Weaker pull
        ...
        val pullDominantOneRepMaxes = listOf(
            "Bench Press" to BigDecimal("100"), // Weaker push
            "Overhead Press" to BigDecimal("80"), // Weaker push
            "Bent-Over Row" to BigDecimal("120"), // Stronger pull
            "Chin-Up" to BigDecimal("100"), // Stronger pull
            "Back Squat" to BigDecimal("160"),
            "Deadlift" to BigDecimal("240")
        )
        setupUserOneRepMaxes(testUser3.id, pullDominantOneRepMaxes)
        
        val programResponse3 = webTestClient.post()
            ...
            .jsonPath("$.id").value<Int> { programId3 ->
                // Generate next week of workouts
                val workoutResponse3 = webTestClient.post()
