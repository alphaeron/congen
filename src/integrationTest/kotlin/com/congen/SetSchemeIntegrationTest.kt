...
class SetSchemeIntegrationTest : BaseIntegrationTest() {
    ...
    override fun setUp() {
        ...
        val exerciseResponse = webTestClient.post()
    ...
    fun `should return 422 when set number is 0`() {
        webTestClient.post()
            .uri("/set-scheme/?programmedExerciseId=$programmedExerciseId&setNumber=0&wasSetPerformed=false&isAmrap=false&isEmom=false&useTempo=false&targetWeight=100.0&targetRepCount=8&restSeconds=120")
            .exchange()
    ...
    fun `should return 422 when set number is negative`() {
        webTestClient.post()
            .uri("/set-scheme/?programmedExerciseId=$programmedExerciseId&setNumber=-1&wasSetPerformed=false&isAmrap=false&isEmom=false&useTempo=false&targetWeight=100.0&targetRepCount=8&restSeconds=120")
            .exchange()
            .expectStatus().isEqualTo(422)
            .expectBody()
    ...
    fun `should return 422 when target weight is 0`() {
        webTestClient.post()
            .uri("/set-scheme/?programmedExerciseId=$programmedExerciseId&setNumber=1&wasSetPerformed=false&isAmrap=false&isEmom=false&useTempo=false&targetWeight=0&targetRepCount=8&restSeconds=120")
            .exchange()
            .expectStatus().isEqualTo(422)
            .expectBody()
    ...
    fun `should return 422 when target rep count is 0`() {
        webTestClient.post()
            .uri("/set-scheme/?programmedExerciseId=$programmedExerciseId&setNumber=1&wasSetPerformed=false&isAmrap=false&isEmom=false&useTempo=false&targetWeight=100.0&targetRepCount=0&restSeconds=120")
            .exchange()
            .expectStatus().isEqualTo(422)
            .expectBody()
    ...
    fun `should return 422 when rest seconds is negative`() {
        webTestClient.post()
            .uri("/set-scheme/?programmedExerciseId=$programmedExerciseId&setNumber=1&wasSetPerformed=false&isAmrap=false&isEmom=false&useTempo=false&targetWeight=100.0&targetRepCount=8&restSeconds=-1")
            .exchange()
            .expectStatus().isEqualTo(422)
            .expectBody()
    ...
    fun `should get set scheme by id`() {
        ...
        val setSchemeResponse = webTestClient.post()
            .uri("/set-scheme/?programmedExerciseId=$programmedExerciseId&setNumber=2&wasSetPerformed=true&isAmrap=false&isEmom=false&useTempo=false&targetWeight=150.0&performedWeight=145.0&targetRepCount=5&performedRepCount=4&restSeconds=180")
            .exchange()
            .expectStatus().isOk()
    ...
    fun `should get set schemes by programmed exercise id`() {
        ...
        webTestClient.post()
            .uri("/set-scheme/?programmedExerciseId=$programmedExerciseId&setNumber=2&wasSetPerformed=false&isAmrap=false&isEmom=false&useTempo=false&targetWeight=110.0&targetRepCount=6&restSeconds=180")
            .exchange()
            .expectStatus().isOk()

        webTestClient.post()
            .uri("/set-scheme/?programmedExerciseId=$programmedExerciseId&setNumber=3&wasSetPerformed=false&isAmrap=true&isEmom=false&useTempo=false&targetWeight=120.0&targetRepCount=10&restSeconds=240")
            .exchange()
            .expectStatus().isOk()
    ...
    fun `should update set scheme`() {
        ...
        webTestClient.patch()
            .uri("/set-scheme/?id=${setSchemeResponse.id}&programmedExerciseId=$programmedExerciseId&setNumber=1&wasSetPerformed=true&isAmrap=false&isEmom=false&useTempo=false&targetWeight=100.0&performedWeight=95.0&targetRepCount=8&performedRepCount=7&restSeconds=120")
            .exchange()
            .expectStatus().isOk()
            .expectBody()
            .jsonPath("$.id").isEqualTo(setSchemeResponse.id)
