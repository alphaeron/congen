...
class ExerciseWorkoutTypeIntegrationTest : BaseIntegrationTest() {
    ...
    fun `should create exercise workout type relationship`() {
        ...
        webTestClient.post()
            .uri("/api/v1/exercise_workout_type/?exerciseName=$uniqueExercise&movementType=horizontal_push&workoutType=dynamic_effort")
            .exchange()
            .expectStatus().isOk()
            .expectBody()
    ...
    fun `should get all exercise workout types`() {
        ...
        webTestClient.post()
            .uri("/api/v1/exercise_workout_type/?exerciseName=$uniqueExercise&movementType=horizontal_push&workoutType=maximal_effort")
            .exchange()
            .expectStatus().isOk()
