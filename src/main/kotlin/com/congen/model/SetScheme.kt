...
@Schema(
    ...
    example = "SetScheme(id=1, programmedExerciseId=5, setNumber=1, wasSetPerformed=true, isAmrap=false, isEmom=false, useTempo=true, eccentricTempo=\"3\", isometricTempo=\"1\", concentricTempo=\"1\", targetWeight=100.0, performedWeight=100.0, targetRepCount=5, performedRepCount=5, restSeconds=180)"
)
