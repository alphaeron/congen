...
class ProgramController(
    ...
    fun save(
        ...
        logger.info("Saving program: {} for user {} with week number 1", name, userId)
        val startingCurrentWeekNumber = 1
        return programDAL.insertProgram(userId, name, startingCurrentWeekNumber)
            .map { savedProgram ->
