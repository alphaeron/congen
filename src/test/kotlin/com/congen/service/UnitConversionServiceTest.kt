...
class UnitConversionServiceTest {
    ...
    fun `should convert kg to kg without change`() {
        ...
        val result = unitConversionService.toKg(weight, WeightUnit.KG)
    ...
    fun `should convert lbs to kg correctly`() {
        ...
        val result = unitConversionService.toKg(weightInLbs, WeightUnit.LBS)
    ...
    fun `should convert kg to lbs correctly`() {
        ...
        val result = unitConversionService.fromKg(weightInKg, WeightUnit.LBS)
    ...
    fun `should convert lbs to kg without change`() {
        val weightInKg = BigDecimal("100.0")
        val result = unitConversionService.fromKg(weightInKg, WeightUnit.KG)
    ...
    fun `should convert between units correctly`() {
        ...
        val result = unitConversionService.convert(weightInLbs, WeightUnit.LBS, WeightUnit.KG)
    ...
    fun `should convert between units correctly reverse`() {
        ...
        val result = unitConversionService.convert(weightInKg, WeightUnit.KG, WeightUnit.LBS)
    ...
    fun `should return same weight when converting to same unit`() {
        val weight = BigDecimal("100.0")
        val result = unitConversionService.convert(weight, WeightUnit.KG, WeightUnit.KG)
        assertEquals(weight, result)
    }
    ...
    fun `should handle zero weight`() {
        ...
        val result = unitConversionService.toKg(weight, WeightUnit.LBS)
    ...
    fun `should handle all unit conversion test cases`(
        ...
        val result =
            when (inputUnit) {
                WeightUnit.KG -> unitConversionService.fromKg(inputWeight, WeightUnit.LBS)
                WeightUnit.LBS -> unitConversionService.toKg(inputWeight, WeightUnit.LBS)
            }
