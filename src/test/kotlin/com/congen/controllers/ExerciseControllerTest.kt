...
class ExerciseControllerTest {
    ...
    fun `save should return saved exercise`() {
        ...
        // When
        val result = exerciseController.save(exercise)
        ...
        verify(exerciseDAL).insertExercise(exercise)
    }
    ...
    fun `get should return not found when exercise not found`() {
        ...
        whenever(exerciseDAL.selectExerciseByName(exerciseName)).thenReturn(Mono.empty())
    ...
    fun `getMuscle should return not found when no muscles found`() {
        ...
        whenever(exerciseMuscleDAL.selectExerciseMuscleByExercise(exerciseName)).thenReturn(Mono.empty())
    ...
    fun `getEquipment should return not found when no equipment found`() {
        ...
        whenever(exerciseEquipmentDAL.selectExerciseEquipmentByExercise(exerciseName)).thenReturn(Mono.empty())
