...
class EquipmentControllerTest {
    ...
    fun `get should return not found when equipment not found`() {
        ...
        whenever(equipmentDAL.selectEquipmentByName(equipmentName)).thenReturn(Mono.empty())
    ...
    fun `getExercise should return not found when no exercises found`() {
        ...
        whenever(exerciseEquipmentDAL.selectExerciseEquipmentByEquipment(equipmentName)).thenReturn(Mono.empty())
